...
Given I was already using Next.js and Vercel, it was compelling to see they also had a storage product. But wait, it gets better... the product page had an entire paragraph dedicated to ***[CHOOSING a database type](https://vercel.com/docs/storage#choosing-a-storage-product)*** 😱:
...
Because I'm a spineless caterpillar, I asked [ChatGPT](https://chat.openai.com/auth/login) to construct me a relational table schema for guests, events, and RSVPs 🥴. Based on its response, I created the following tables below:
...
3. **Registrys...** <br />
    ...
    How the heck is that gonna work? I wonder if I could just create a registry using Zola or The Knot... and then hook that up to my site manually. If anyone knows, please shoot me a DM. Or, leave a comment... once I make it possible to leave comments on my blog posts 😉

Thank you very much for reading, and I hope you enjoy the wedding website.

![Peace gif](https://media.giphy.com/media/Ru9sjtZ09XOEg/giphy.gif)